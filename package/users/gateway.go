...
type Gateway interface {
	...
	UpdateStudentByEmail(student *models.StudentCore) (studentUpdated *models.StudentCore, err error)
	DeleteStudent(studentId string) (err error)
	GetStudentByEmail(email string) (student *models.StudentCore, err error)

...
type Delegate interface {
	...
	GetAllRobboUnits(page, pageSize string) (robboUnits []*models.RobboUnitHTTP, countRows int, err error)
	...
	SearchRobboUnitsByName(name, page, pageSize string) (robboUnits []*models.RobboUnitHTTP, countRows int, err error)
}

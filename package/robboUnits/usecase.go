...
type UseCase interface {
	...
	GetAllRobboUnits(page, pageSize int) (robboUnits []*models.RobboUnitCore, countRows int64, err error)
	...
	SearchRobboUnitsByName(name string, page, pageSize int) (robboUnits []*models.RobboUnitCore, countRows int64, err error)
}

...
type MutationResolver interface {
	...
	CreateStudentTeacherRelation(ctx context.Context, studentID string, teacherID string) (string, error)
	DeleteStudentTeacherRelation(ctx context.Context, studentID string, teacherID string) (string, error)
...
type QueryResolver interface {
	...
	GetStudentsByTeacherID(ctx context.Context, teacherID string) ([]*models.StudentHTTP, error)
	...
	GetTeachersByStudentID(ctx context.Context, studentID string) ([]*models.TeacherHTTP, error)
...
type Mutation {
    ...
    createStudentTeacherRelation(studentId: String!, teacherId: String!): String!
    deleteStudentTeacherRelation(studentId: String!, teacherId: String!): String!

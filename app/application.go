...
func InvokeWith(options ...fx.Option) *fx.App {
	...
	var di = []fx.Option{
		...
		fx.Provide(robboUnitsgateway.SetupProjectPageGateway),
		...
		fx.Provide(robboUnitsusecase.SetupProjectPageUseCase),
		...
		fx.Provide(robboUnitsdelegate.SetupProjectPageDelegate),
